...
//        iarr1 = new int[][4]; -> ※ 주소를 묶어서 관리할 배열의 크기를 지정하지 않으면 에러 발생!!
        iarr1 = new int[3][]; // -> 정변배열 (크기가 같을때)

        /* 3. 주소를 관리하는 배열의 인덱스마다 배열을 할당(heap) */
        //    행           열
        iarr1[0] = new int[5]; // -> 가변배열
        iarr1[1] = new int[5]; // -> 가변배열
        iarr1[2] = new int[5]; // -> 가변배열

        /* 위의 2,3번을 동시에 진행 할 수 있다.
        ...
        * 기본 값이 담겨 있다. */
        ...
        for ( int i = 0; i < iarr1.length; i++ ){
            // 내부 for문은 '열'을 반복.
            for ( int j = 0; j < iarr1[0].length; j++) {
