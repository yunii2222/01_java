...
public class Application2 {
    public static void main(String[] args) {
        ...
        * => 선언은 stack에 배열의 주소를 보관할 수 있는 공간을 만드는 것 */
        ...
        /* 선언한 레퍼런스 변수에 배열을 할당하여 대입하 수 있다.
    ...
    //   iarr = new int[]; // 할당할 크기는 반드시 지정 되어야 한다.
        ...
        /* heap 메모리는 이름으로 접근하는 것이ㅐ 아니라 주소로 접근하는 영역이다.
        * stack에 저장 된 주소로 heap에 할당 된 배열을 찾아갈 수 있다. */
        System.out.println("iarr : " + iarr);
        System.out.println("darr : " + darr );

        /* hashCode() : 객체의 주소 값을 10재진수로 변환하여 생성한 객체의 고유한 정수 값을 반환 하는 메소드 */
        System.out.println( "iarr.hashCode() : " + iarr.hashCode() ); // 10진수 주소 값
        System.out.println( "darr.hashCode() : " + darr.hashCode() ); // 10진수 주소 값
