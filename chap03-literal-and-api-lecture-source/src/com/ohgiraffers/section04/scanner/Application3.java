...
public class Application3 {
    public static void main(String[] args) {
        ...
        * 2. 정수, 실수, 논리값 입력후 nextLine()으로 문자열 입력 받을 때*/
        ...
        /* 공백을 포함한 문자열을 입력하게 되면 입력 버퍼에 남아있는 문자열로 인해 nextInt() 메소드가
        * 해당 값을 숫자로 변경하지 못해 InputMismatchException이 발생할 수 있는 가능성이 있다.
        * => 공백이 있는 문자열을 입력 받아야 할 경우에는 next가 아닌 nextLine()을 사용한다. */
        ...
        /* 입력 버퍼에 남아있는 개행문자로 인해 이어지는 nextLine()이 아무 값도 받지 않고 빈 문자열로 처리된다.
