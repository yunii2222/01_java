...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 숫자가 아닌 값을 입력하면 java.util.InputMismatchException이 발생한다.
        * int 범위를 초과한 값을 입력하게 되어도 java.util.InputMismatchException이 발생한다.*/
        System.out.print( "나이를 입력하세요 : " );
        int age = sc.nextInt();
        System.out.println( "입력하신 나이를 : " + age + "세입니다." );
        ...
        * true or false 외의 다른 값을 입력하면 InputMismatchException 발생 */
        System.out.print( "참과 거짓 중 하나를 true or false로 입력하세요 : " );
        ...
        * 만약 존재하지 않는 인덱스를 입력하게 되면 java.lang.StringIndexOutOfException이 발생한다.*/
        System.out.println( "아무 문자나 입력하세요" );
        char ch = sc.nextLine().charAt(0);
        System.out.println("입력하신  : " + ch + "입니다." );
    }
}
