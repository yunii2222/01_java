...
public class OperatorType {
	...
	public static void main(String[] args) {
		...
		DoubleBinaryOperator doubleBinaryOperator = (db1, db2) -> db1 + db2;
		System.out.println(doubleBinaryOperator.applyAsDouble(4.4, 4.6));
		
		/* 4. DoubleUnaryOperator#applyAsDouble(double d) : double : 매개변수 한 개를 이용하여 연산 후 double 타입으로 리턴한다. */
		DoubleUnaryOperator doubleUnaryOperator = (db) -> db;
		System.out.println(doubleUnaryOperator.applyAsDouble(3.9)) ;
		...
		System.out.println(intBinaryOperator.applyAsInt(40, 50));
